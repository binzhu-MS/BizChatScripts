...
def main(
    ...
    Example usage:
        ...
        python valid_json.py --input_path=data.json
        
        # Validate and save results
        python valid_json.py --input_path=data.json --output_path=validation_results.json
        
        # Silent mode (no console output)
        python valid_json.py --input_path=data.json --silent=True
        
        # Include parsed data in output
        python valid_json.py --input_path=data.json --save_parsed=True
    """
    try:
